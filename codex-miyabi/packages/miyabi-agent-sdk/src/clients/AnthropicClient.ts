...
export class AnthropicClient {
  ...
  async analyzeIssue(
    title: string,
    body: string | null
  ): Promise<IssueAnalysisResult & { tokensUsed: TokenUsage }> {
    ...
    const result = this.parseJSON<IssueAnalysisResult>(content.text);
  ...
  async generateCode(
  ...
  ): Promise<CodeGenerationResult & { tokensUsed: TokenUsage }> {
    ...
    const result = this.parseJSON<CodeGenerationResult>(content.text);
  ...
  async reviewCode(
  ...
  ): Promise<CodeReviewResult & { tokensUsed: TokenUsage }> {
    ...
    const result = this.parseJSON<CodeReviewResult>(content.text);
